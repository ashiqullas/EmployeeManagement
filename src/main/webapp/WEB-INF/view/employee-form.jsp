...
<title>Employee Form | Employee Management</title>
   ...
   <li><a href="${pageContext.request.contextPath}/logout">Logout</a></li>
	...
	<form:form action = "saveEmployee" modelAttribute = "employee" method = "POST" >
		...
		<table>
			<tbody>
				...
				<tr>
					...
					<td>Male<form:radiobutton path = "gender" value="male"/>| Female<form:radiobutton  path = "gender" value="female"/><form:errors path="gender" cssClass="error"/>
					</td>
				</tr> 
				<tr>
        ...
        <form:option value="103" label="103"/>  
				...
				<tr>
					<td colspan="2"><center><input type = "submit" value = "SAVE" class = "button" /> | <input type="reset" value="RESET" class="button"> </center></td>
				</tr> 
			</tbody>
		</table>
